 ...
 * @author apple
 */
public class SihhiyeBosYer extends DataManager {

    /**
     * Creates new form SihhiyeBosYer
     */
    public SihhiyeBosYer() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SihhiyeBosYer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SihhiyeBosYer().setVisible(true);
            }
        });
    }
